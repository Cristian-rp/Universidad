...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 0, 20, -1));

        Minimizar.setFont(new java.awt.Font("Malgun Gothic Semilight", 1, 36)); // NOI18N
        Minimizar.setForeground(new java.awt.Color(0, 51, 51));
        Minimizar.setText("-");
        ...
        jPanel1.add(Minimizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 0, 20, 30));
    ...
    private void Btn_Login1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_Login1MouseClicked
        ...
        if(Txt_Login_user.getText().equals(usuario)&& pass.equals(contraseña)){
            ...
            //Se cierra la ventana actual(Inicio)
            dispose();
        }
        else{
    ...
    private javax.swing.JLabel Btn_Login_Register;
